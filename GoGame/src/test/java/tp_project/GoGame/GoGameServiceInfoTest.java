...
public class GoGameServiceInfoTest {
    ...
    public void test1() {
        ...
        assertEquals(13, inf.board_size);
        ...
        assertEquals("9;5;1,true,0;2,true,0;3,false,1;4,true,1;5,false,0;", inf.toText());
    ...
    public void test2() {
        ...
        inf.fromText("19;3;A,true,3;B,false,1;C,false,2;");
        ...
        assertEquals(19, inf.board_size);
    }

    @Test(expected = IllegalArgumentException.class)
    public void test3() {
        GoGameServiceInfo inf = new GoGameServiceInfo();
        inf.fromText("9;20;A,false,8;");
    }

    @Test(expected = IllegalArgumentException.class)
    public void test4() {
        GoGameServiceInfo inf = new GoGameServiceInfo();
        inf.fromText("9;dsadsad;4,true,5;");
    }

    @Test
    public void test5() {
        GoGameServiceInfo inf = new GoGameServiceInfo();
        inf.fromText("9;1;A,dd,3;");
